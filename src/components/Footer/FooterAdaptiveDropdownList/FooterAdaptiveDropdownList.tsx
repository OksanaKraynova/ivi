...
import styles from './FooterAdaptiveDropdownList.module.scss';
...
interface FooterAdaptiveDropdownListProps {
  subTitle?: IItemLink;
...
export const FooterAdaptiveDropdownList: FC<FooterAdaptiveDropdownListProps> = (props) => {
